...
static WORD16 StratRemove(RP FAR*)
  {
  ...
  // For now, we don't understand this command
  return RPDONE | RPERR_COMMAND;
  }


static WORD16 StratShutdown(RP FAR*)
  {
...
static WORD16 StratError(RP FAR*)
  {
